def Test_Open_Desktop_Script_Calling_Keyword():
    ...
    #Runs a keyword test.
    KeywordTests.Update_Record.Run()
    #Runs a keyword test.
    KeywordTests.Delete_Record.Run()
    #Runs a keyword test.
    KeywordTests.Generate_Customer_List.Run()
...
def Script_Test_Open_Desktop_Call_Script():
    import Desktop_Mod
    #The beginning of the Open Application group
    #Runs the "Orders" tested application.
    TestedApps.Orders.Run(1, True)
    ...
    Desktop_Mod.Update_Record_Script()
    #Runs a script routine.
    Desktop_Mod.Delete_Record_Script()
    #Runs a script routine.
    Desktop_Mod.Generate_Customer_List_Script()
    #Runs a keyword test.
    KeywordTests.Close_App.Run()
    #Delays the test execution for the specified time period.
    Delay(5000, "Pause to allow window to quiesce")
